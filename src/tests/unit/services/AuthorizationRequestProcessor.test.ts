...
describe("AuthorizationRequestProcessor", () => {
	...
	describe("getInstance", () => {
		it("returns the same AuthorizationRequestProcessor singleton on subsequent calls", () => {
			const firstInstance = AuthorizationRequestProcessor.getInstance();
			const secondInstance = AuthorizationRequestProcessor.getInstance();

			expect(firstInstance).toBeInstanceOf(AuthorizationRequestProcessor);
