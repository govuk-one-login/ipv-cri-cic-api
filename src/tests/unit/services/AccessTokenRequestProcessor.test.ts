...
describe("AccessTokenRequestProcessor", () => {
	...
	describe("getInstance", () => {
		it("returns the same AccessTokenRequestProcessor singleton on subsequent calls", () => {
			const firstInstance = AccessTokenRequestProcessor.getInstance();
			const secondInstance = AccessTokenRequestProcessor.getInstance();

			expect(firstInstance).toBeInstanceOf(AccessTokenRequestProcessor);
