...
describe("UserInfoRequestProcessor", () => {
	...
	describe("getInstance", () => {
		it("returns the same UserInfoRequestProcessor singleton on subsequent calls", () => {
			const firstInstance = UserInfoRequestProcessor.getInstance();
			const secondInstance = UserInfoRequestProcessor.getInstance();

			expect(firstInstance).toBeInstanceOf(UserInfoRequestProcessor);
