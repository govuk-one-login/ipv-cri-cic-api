...
export async function stubStartPost(body:{}) {
	try {
...
export async function sessionPost(clientId?: string, request?: string) {
	try {
...
export async function claimedIdentityPost(given_names?: string, family_names?: string, dob?: string, doc_selected?: string, doe?: string, sessID?: string) {
	try {
...
export async function authorizationGet(sessionId: string) {
	try {
...
export async function tokenPost(authCode?: any, redirectUri?: any ) {
	try {
		const path = "/token";
...
export async function userInfoPost(accessToken?: any) {
	try {
		const path = "/userInfo";
...
export async function wellKnownGet() {
	try {
