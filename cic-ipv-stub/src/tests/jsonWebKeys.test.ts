...
describe('JWKS Endpoint', () => {
  beforeEach(() => {
    ...
    mockKmsClient
      ...
      .resolves({
        KeyId: 'test',
        PublicKey: Buffer.from('MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAES4sDJifz8h3GDznZZ6NC3QN5qlQn8Zf2mck4yBmlwqvXzZu7Wkwc4QuOxXhGHXamfkoG5d0UJVXJwwvFxiSzRQ==', 'base64'),
