...
import { expect, jest, it, beforeEach, afterEach, describe } from '@jest/globals'
...
describe('Start CIC Check Endpoint', () => {
  beforeEach(() => {
    ...
    kmsClient
      .on(SignCommand)
      .resolves({
        Signature: 'MEQCIDFOuMwnJRri5vbFVrwSwQP2JJa/qTmynuB9txk4nmfzAiAvHJ9D1YZY+9YsiQevt5GaAmqX5zaGvr2QIMFuJWKsJg=='
      })
  })
